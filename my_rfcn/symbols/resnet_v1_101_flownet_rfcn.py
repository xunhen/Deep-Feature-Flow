...
class resnet_v1_101_flownet_rfcn(Symbol):
    ...
    def get_train_symbol(self, cfg):
        ...
        warp_conv_feat = scale_map * (warp_conv_feat + residual_map)
    ...
    def init_weight(self, cfg, arg_params, aux_params):
        ...
        arg_params['Convolution5_residual_weight'] = mx.random.normal(0, 0.01,
                                                                      shape=self.arg_shape_dict[
                                                                          'Convolution5_residual_weight'])
